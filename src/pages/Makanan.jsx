...
const provinces = [
    ...
    "Sulawesi Tengah", "Sulawesi Tenggara", "Sulawesi Utara", "Sumatra Barat", 
                    ...
                    <div className='flex flex-col items-center h-full w-full absolute top-5'>
                        ...
                        <div className='relative w-1/4 mt-4'>
                            <select
                                ...
                                className='w-full h-10 rounded-lg text-lg font-body outline-none p-2 pr-12'
                            >
                                <option value="">Filter Berdasarkan Provinsi</option>
                                {provinces.map((province) => (
                                    <option key={province} value={province.toLowerCase().replace(/ /g, '_')}>
                                        {province}
                                    </option>
                                ))}
                            </select>
                        </div>
                        <h2 data-aos="fade-up" data-aos-duration="1000" className='font-body text-white text-center w-3/4 mt-5'>
