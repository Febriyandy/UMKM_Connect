...
const Kemitraan = () => {
  ...
  return (
    ...
    <section className='w-full h-auto py-20 bg-white flex '>
      ...
      <div data-aos="fade-up" data-aos-duration="1000" className='w-1/2 h-full pr-20 pl-10 flex flex-col justify-center'>
        <img src={Mitra} data-aos="zoom-in" data-aos-duration="1000" className='object-cover w-full h-auto' alt="" />
